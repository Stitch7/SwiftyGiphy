...
public class SwiftyGiphyViewController: UIViewController {
    ...
    public override func viewWillLayoutSubviews() {
        ...
        {
            collectionView.contentInset = UIEdgeInsets(top: self.topLayoutGuide.length + 44.0, left: 0.0, bottom: 10.0, right: 0.0)
            collectionView.scrollIndicatorInsets = UIEdgeInsets(top: self.topLayoutGuide.length + 44.0, left: 0.0, bottom: 10.0, right: 0.0)
        }
    }
